<?php
/**
 * Royale News Theme Info Configurations
 *
 * @package Themebeez_Toolkit
 */

if( ! function_exists( 'themebeez_toolkit_royale_news_config'  ) ) {

	function themebeez_toolkit_royale_news_config() {
		...
		$config = array(
			...
			'quick_links' => array(
				...
				'demo_url' => array(
					...
					'url'  => 'https://themebeez.com/demos/?theme=royale-news',
					),
...
add_action( 'after_setup_theme', 'themebeez_toolkit_royale_news_config' );

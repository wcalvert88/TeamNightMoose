<?php
/**
 * StyleBlog Theme Info Configurations
 *
 * @package Themebeez_Toolkit
 */

if( ! function_exists( 'themebeez_toolkit_styleblog_config'  ) ) {

	function themebeez_toolkit_styleblog_config() {
		...
		$config = array(
			...
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'themebeez-toolkit' ), 'StyleBlog' ),
			...
			'quick_links' => array(
				...
				'demo_url' => array(
					...
					'url'  => 'https://themebeez.com/demos/style-blog/',
					),
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'  			=> 'https://themebeez.com/themes/style-blog/',
					'is_button'    			=> true,
					'recommended_actions' 	=> false,
					'is_new_tab'   			=> true,
				),
...
add_action( 'after_setup_theme', 'themebeez_toolkit_styleblog_config' );

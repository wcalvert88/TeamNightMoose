 ...
 * @return array Files.
 */
function magazine_saga_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Theme Demo Content', 'magazine-saga' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'assets/data/magazine-saga.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'assets/data/magazine-saga.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'assets/data/magazine-saga.dat',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'magazine_saga_import_files' );
...
function magazine_saga_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'magazine_saga_after_import_setup' );